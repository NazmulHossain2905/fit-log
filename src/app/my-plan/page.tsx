...
export default function MyPlanPage() {
  return (
    <section className="container mx-auto space-y-6 px-6 py-10">
      ...
      <div className="pt-2">
        <div className="flex w-fit items-center gap-1 rounded-xl border border-[#232732] bg-[#151921] p-1">
